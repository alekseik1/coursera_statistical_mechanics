...
\pythonfile{../w5/programs_tutorial_5/free_periodic_sine_cosine}{Подсчет ВФ свободной частицы (\texttt{free\_periodic\_sine\_cosi.py})}{code:free-periodic-sine-cosine}
...
\pythonfile{../w5/programs_tutorial_5/free_periodic_complex_exp}{Подсчет ВФ свободной частицы через комплексную экспоненту (\texttt{free\_periodic\_complex\_exp.py}}{code:free-periodic-complex-exp}
...
\pythonfile{../w5/programs_tutorial_5/quantum_time_evolution}{Эволюция во времени для квантовой частицы (\texttt{quantum\_time\_evolution.py})}{code:quantum_time_evolution}
